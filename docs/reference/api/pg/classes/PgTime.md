[monolayer-monorepo](../../index.md) / [pg](../index.md) / PgTime
...
> **default**(`value`): [`PgTime`](PgTime.md) & `WithDefaultColumn`
...
[`PgTime`](PgTime.md) & `WithDefaultColumn`
...
> **notNull**(): [`PgTime`](PgTime.md) & `NonNullableColumn`
...
[`PgTime`](PgTime.md) & `NonNullableColumn`

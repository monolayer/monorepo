...
--
ALTER TABLE
  ONLY public.monolayer_alter_migration_lock
ADD
  CONSTRAINT monolayer_alter_migration_lock_pkey PRIMARY KEY (id);

--
-- Name: monolayer_alter_migration monolayer_alter_migration_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
ALTER TABLE
  ONLY public.monolayer_alter_migration
ADD
  CONSTRAINT monolayer_alter_migration_pkey PRIMARY KEY (name);

...
import { dropSchemaChangeset } from "./generators/schema-drop.js";
...
import { changeTriggerChangeset } from "./generators/trigger-change.js";
import {
...
const schemas = [
	codeChangeset({
		validate: isCreateSchemaDiff,
		process: createSchemaChangeset,
	}),
	codeChangeset({
		validate: isDropSchemaDiff,
		process: dropSchemaChangeset,
	}),
];
...
const trigger = [
	...
	codeChangeset({
		...
		process: changeTriggerChangeset,
	}),
];

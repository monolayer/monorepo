	...
	test<DbContext>("rename foreign key child table", async (context) => {
		...
		const expected = [
			...
			},
			{
				...
				up: [
					[
						'await sql`ALTER TABLE "public"."persons" RENAME CONSTRAINT users_c02e3d7d_monolayer_fk TO persons_c02e3d7d_monolayer_fk`',
						"execute(db);",
					],
				],
				down: [
					[
						'await sql`ALTER TABLE "public"."persons" RENAME CONSTRAINT persons_c02e3d7d_monolayer_fk TO users_c02e3d7d_monolayer_fk`',
						"execute(db);",
					],
				],
			},
	...
	test<DbContext>("rename foreign key parent table", async (context) => {
		...
		const expected = [
			...
			},
			{
				...
				up: [
					[
						'await sql`ALTER TABLE "public"."users" RENAME CONSTRAINT users_c02e3d7d_monolayer_fk TO users_7e0fa77c_monolayer_fk`',
						"execute(db);",
					],
				],
				down: [
					[
						'await sql`ALTER TABLE "public"."users" RENAME CONSTRAINT users_7e0fa77c_monolayer_fk TO users_c02e3d7d_monolayer_fk`',
						"execute(db);",
					],
				],
			},
	...
	test<DbContext>("rename foreign key parent table and child table", async (context) => {
		...
		const expected = [
			...
			},
			{
				...
				up: [
					[
						'await sql`ALTER TABLE "public"."persons" RENAME CONSTRAINT users_c02e3d7d_monolayer_fk TO persons_7e0fa77c_monolayer_fk`',
						"execute(db);",
					],
				],
				down: [
					[
						'await sql`ALTER TABLE "public"."persons" RENAME CONSTRAINT persons_7e0fa77c_monolayer_fk TO users_c02e3d7d_monolayer_fk`',
						"execute(db);",
					],
				],
			},
	...
	test<DbContext>("rename foreign key child table", async (context) => {
		...
		const expected = [
			...
			},
			{
				...
				up: [
					[
						'await sql`ALTER TABLE "public"."user_books" RENAME CONSTRAINT users_c02e3d7d_monolayer_fk TO user_books_c02e3d7d_monolayer_fk`',
						"execute(db);",
					],
				],
				down: [
					[
						'await sql`ALTER TABLE "public"."user_books" RENAME CONSTRAINT user_books_c02e3d7d_monolayer_fk TO users_c02e3d7d_monolayer_fk`',
						"execute(db);",
					],
				],
			},
	...
	test<DbContext>("rename foreign key parent table", async (context) => {
		...
		const expected = [
			...
			},
			{
				...
				up: [
					[
						'await sql`ALTER TABLE "public"."users" RENAME CONSTRAINT users_c02e3d7d_monolayer_fk TO users_0ea2ca34_monolayer_fk`',
						"execute(db);",
					],
				],
				down: [
					[
						'await sql`ALTER TABLE "public"."users" RENAME CONSTRAINT users_0ea2ca34_monolayer_fk TO users_c02e3d7d_monolayer_fk`',
						"execute(db);",
					],
				],
			},
	...
	test<DbContext>("rename foreign key parent table and child table", async (context) => {
		...
		const expected = [
			...
			},
			{
				...
				up: [
					[
						'await sql`ALTER TABLE "public"."user_books" RENAME CONSTRAINT users_c02e3d7d_monolayer_fk TO user_books_0ea2ca34_monolayer_fk`',
						"execute(db);",
					],
				],
				down: [
					[
						'await sql`ALTER TABLE "public"."user_books" RENAME CONSTRAINT user_books_0ea2ca34_monolayer_fk TO users_c02e3d7d_monolayer_fk`',
						"execute(db);",
					],
				],
			},
	...
	test<DbContext>("rename composite foreign keys child table", async (context) => {
		...
		const expected = [
			...
			},
			{
				...
				up: [
					[
						'await sql`ALTER TABLE "public"."book_users" RENAME CONSTRAINT users_c02e3d7d_monolayer_fk TO book_users_6de35d86_monolayer_fk`',
						"execute(db);",
					],
				],
				down: [
					[
						'await sql`ALTER TABLE "public"."book_users" RENAME CONSTRAINT book_users_6de35d86_monolayer_fk TO users_c02e3d7d_monolayer_fk`',
						"execute(db);",
					],
				],
			},
	...
	test<DbContext>("rename composite foreign keys parent table", async (context) => {
		...
		const expected = [
			...
			},
			{
				...
				up: [
					[
						'await sql`ALTER TABLE "public"."users" RENAME CONSTRAINT users_c02e3d7d_monolayer_fk TO users_462ff70f_monolayer_fk`',
						"execute(db);",
					],
				],
				down: [
					[
						'await sql`ALTER TABLE "public"."users" RENAME CONSTRAINT users_462ff70f_monolayer_fk TO users_c02e3d7d_monolayer_fk`',
						"execute(db);",
					],
				],
			},
	...
	test<DbContext>("rename composite foreign keys parent table and child table", async (context) => {
		...
		const expected = [
			...
			},
			{
				...
				up: [
					[
						'await sql`ALTER TABLE "public"."user_books" RENAME CONSTRAINT users_c02e3d7d_monolayer_fk TO user_books_462ff70f_monolayer_fk`',
						"execute(db);",
					],
				],
				down: [
					[
						'await sql`ALTER TABLE "public"."user_books" RENAME CONSTRAINT user_books_462ff70f_monolayer_fk TO users_c02e3d7d_monolayer_fk`',
						"execute(db);",
					],
				],
			},

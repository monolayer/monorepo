...
--
ALTER TABLE
  ONLY public.monolayer_unsafe_migration_lock
ADD
  CONSTRAINT monolayer_unsafe_migration_lock_pkey PRIMARY KEY (id);

--
-- Name: monolayer_unsafe_migration monolayer_unsafe_migration_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
ALTER TABLE
  ONLY public.monolayer_unsafe_migration
ADD
  CONSTRAINT monolayer_unsafe_migration_pkey PRIMARY KEY (name);
